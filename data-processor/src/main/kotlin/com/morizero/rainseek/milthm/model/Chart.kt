...
data class Chart(
    ...
    @field:JsonDeserialize(using = StringOrStringList::class) var illustration: List<String> = emptyList(),

    @field:JsonDeserialize(using = StringOrStringList::class) var illustrationSquare: List<String> = emptyList(),
